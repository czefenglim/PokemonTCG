...
export default function PokemonCart({
  ...
  const handleCheckout = () => {
    if (onCheckout) {
      ...
      // You can integrate with Stripe or other payment processors here
    }
  };
              ...
              <div className="border-t border-gray-100 bg-white p-6 space-y-6">
                ...
                <div className="space-y-4">
                  <motion.button
                    ...
                    className="w-full bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 text-white font-semibold py-4 rounded-2xl transition-all duration-200 shadow-lg hover:shadow-xl text-lg"
                  >
                    Proceed to Checkout
                  </motion.button>
                  <button
