  ...
  const handleRespondToSent = async (
    ...
    try {
      ...
      if (action === "accepted") {
        ...
        console.log("Approval granted to TradeContract");
        ...
        console.log("NFT deposited into TradeContract");
      }
                          ...
                          <div className="flex items-center gap-3">
                            {req.receiverStatus === "accepted" && (
                              <button
                                ...
                                className="bg-gradient-to-r from-blue-500 to-cyan-500 text-white px-6 py-3 rounded-xl font-semibold hover:shadow-lg hover:shadow-blue-500/30 transition-all duration-300 hover:scale-105"
                              >
                                Complete Trade
                              </button>
                            )}
              ...
              <div className="flex gap-4 mt-8">
                {selectedRequest.type === "received" ? (
                  ...
                  <>
                    ...
                    >
                      {isProcessing ? "Processing..." : "Complete Trade"}
                    </button>
                  </>
                ) : (
                  <button
